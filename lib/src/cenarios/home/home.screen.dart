...
import 'package:maosunidas/src/cenarios/cen5/cen5a.gate.dart';
import 'package:maosunidas/src/cenarios/cen5/cen5b.gate.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              buildButton(
                title: HomeStrings.CEN_5A_TITLE,
                ...
                onTap: () async {
                  ...
                  await Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Cen5aGate()));
                },
              ),
              buildButton(
                title: HomeStrings.CEN_5B_TITLE,
                description: HomeStrings.CEN_5_DESC,
                onTap: () async {
                  await setupNotifs();
                  GetIt.I.get<AcaoController>().acao =
                      MockAcoes.all.first.copyWith()..userIsRegistered = true;

                  GetIt.I.get<AcaoController>().isUserFromTheOng = false;

                  await Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Cen5bGate()));
                },
              ),
              buildButton(
                ...
                onTap: () async {
                  ...
                  GetIt.I.get<AcaoController>().acao =
                      MockAcoes.all.first.copyWith();
                  GetIt.I.get<NotifController>().isNotifOn = false;
